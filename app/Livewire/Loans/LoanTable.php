        ...
        if ($row->status === LoanStatus::Pending) {
            ...
            $actions[] = Button::add('approve')
                ...
                ->dispatch('open-delete-modal', [
                    ...
                    'params' => ['rowId' => $row->id],
                    'title' => 'Approve Loan?',
                    'description' => "Are you sure you want to approve Loan #{$row->code} for {$borrowerName}? Stock will be deducted.",
            ...
            $actions[] = Button::add('reject')
                ->slot('<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4"><path stroke-linecap="round" stroke-linejoin="round" d="M9.75 9.75l4.5 4.5m0-4.5l-4.5 4.5M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>')
                ...
                ->dispatch('open-delete-modal', [
                    ...
                    'params' => ['rowId' => $row->id],
                    'title' => 'Reject Loan?',
                    'description' => "Are you sure you want to reject Loan #{$row->code} for {$borrowerName}?",
            ...
            $actions[] = Button::add('delete')
                ...
                ->dispatch('open-delete-modal', [
                    ...
                    'params' => ['rowId' => $row->id],
                    'title' => 'Delete Loan?',
                    'description' => "Are you sure you want to delete Loan #{$row->code} for {$borrowerName}? This action cannot be undone.",
            ...
            $actions[] = Button::add('restore')
                ...
                ->dispatch('open-delete-modal', [
                    ...
                    'params' => ['rowId' => $row->id],
                    'title' => 'Restore Loan?',
                    'description' => "Are you sure you want to restore Loan #{$row->code} for {$borrowerName} to Pending?",
