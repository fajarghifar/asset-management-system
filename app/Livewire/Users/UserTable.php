        ...
        return [
            ...
            Button::add('delete')
                ...
                ->dispatch('open-delete-modal', [
                    ...
                    'description' => __("Are you sure you want to delete user ':name'? This action cannot be undone.", ['name' => $row->name]),
                ])
    ...
    public function delete($rowId): void
    {
        ...
        if ($user) {
            try {
                ...
                $this->dispatch('toast', message: __("User ':name' deleted successfully.", ['name' => $name]), type: 'success');
            } catch (\Exception $e) {
                $this->dispatch('toast', message: __('Failed to delete user: :message', ['message' => $e->getMessage()]), type: 'error');
            }
        }
    }
}
