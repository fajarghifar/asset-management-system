        ...
        return [
            ...
            Button::add('delete')
                ...
                ->dispatch('open-delete-modal', [
                    ...
                    'description' => __("Are you sure you want to delete location ':name' (:code)? This action cannot be undone.", ['name' => $row->name, 'code' => $row->code]),
                ])
                ->tooltip(__('Delete Location')),
        ];
    }
    ...
    public function delete($rowId, LocationService $service): void
    {
        ...
        if ($location) {
            try {
                ...
                $this->dispatch('toast', message: __("Location ':identifier' deleted successfully.", ['identifier' => $identifier]), type: 'success');
            } catch (LocationException $e) {
                $this->dispatch('toast', message: $e->getMessage(), type: 'error');
            } catch (\Throwable $e) {
                $this->dispatch('toast', message: __('Failed to delete location: An unexpected error occurred.'), type: 'error');
            }
        }
    }
}
