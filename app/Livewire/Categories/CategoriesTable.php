        ...
        return [
            ...
            Button::add('delete')
                ...
                ->dispatch('open-delete-modal', [
                    ...
                    'description' => __("Are you sure you want to delete category ':name'? This action cannot be undone.", ['name' => $row->name]),
                ])
    ...
    public function delete($rowId, CategoryService $service): void
    {
        ...
        if ($category) {
            try {
                ...
                $this->dispatch('toast', message: __("Category ':name' deleted successfully.", ['name' => $name]), type: 'success');
            } catch (CategoryException $e) {
                $this->dispatch('toast', message: $e->getMessage(), type: 'error');
            } catch (\Exception $e) {
                $this->dispatch('toast', message: __('Failed to delete category: :message', ['message' => $e->getMessage()]), type: 'error');
            }
        }
    }
}
